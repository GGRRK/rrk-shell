...
Singleton {
    ...
    // "Screen off" on this laptop = lock + DPMS off (scripts/screen-off.sh). NOT systemctl suspend: untested on nouveau
    // (suspend used to kill the GPU, 2026-09-13/14). Any key press brings the picture back.
